...
- Run the updated `nht_role_access_migration.sql` once in Supabase after deploying V13. Existing users and their assigned roles do not need to be recreated.


## V13 data logic correction
...
V13 fixes merged-cell Month validation in the source Excel and restores the Attrition Analysis chart with month/location-aware filtering.
